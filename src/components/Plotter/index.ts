...
export class Plotter {
    ...
    public Run() {
        ...
        this._i = setInterval(() => {
            ...
            if (nexElement == null) {
                ...
                this._grid.Clear();
                this._grid.DrawGrid();
                this._grid.DrawPlanetCollection(nexElement.Objects);
            }
    ...
    public DataFrameSelect(frameId: number) {
        ...
        this._grid.Clear();
        this._grid.DrawGrid();
        this._grid.DrawPlanetCollection(this._frames![frameId].Objects);
    }

    public set UpdateDataset(objects: Array<IDrawObjects>) {
        this._frames = objects.map(obj => new DrawObjectFrame(obj));
        this._grid.DrawPlanetCollection(this._frames[0].Objects);
    }
}
